...
<div class="row">
    <div class="container">
        ...
        <div class="container text-left">
            <a href="<%=request.getContextPath()%>/SaveAlbumServlet" class="btn btn-success">Add New Album</a>
        </div>
        <br>
        ...
        <table class="table table-bordered">
            ...
            <c:forEach var="album" items="${requestScope.listAlbums}">
                <tr>
                    ...
                    <td>
                        <a href="${pageContext.request.contextPath}/ViewTrackServlet?albumid=<c:out value="${album.id}"/>">View Tracks</a>
                    </td>
                    <td>
                        <a href="${pageContext.request.contextPath}/EditAlbumServlet?id=<c:out value="${album.id}"/>">Edit</a> &nbsp <a href="${pageContext.request.contextPath}/DeleteAlbumServlet?id=<c:out value="${album.id}"/>">Delete</a>
                    </td>
                </tr>
            </c:forEach>
            </tbody>
