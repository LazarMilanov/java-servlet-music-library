            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <form action="EditAlbumServlet" method="post">
                        ...
                        <c:if test="${requestScope.album == null}">
                        <form action="SaveAlbumServlet" method="post">
                            </c:if>
                            ...
                            <c:if test="${requestScope.album != null}">
                                <input type="hidden" name="id" value="<c:out value='${requestScope.album.id}' />" />
                            </c:if>

                            <fieldset class="form-group">
                                <label>Album title</label>
                                <input type="text" value="<c:out value='${requestScope.album.title}' />" class="form-control" name="title" required="required">
                            </fieldset>
                                ...
                                <select name="artist" class="form-control" required="required">
                                    <c:if test="${requestScope.album != null}">
                                        ...
                                        <c:forEach var="artist" items="${requestScope.listArtists}">
                                            <c:choose>
                                                <c:when test="${artist.id == requestScope.album.artist.id}">
