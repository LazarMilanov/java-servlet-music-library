        ...
        <table class="table table-bordered">
            ...
            <c:forEach var="album" items="${requestScope.listAlbums}">
                <tr>
                    ...
                    <td>
                        <a href="${pageContext.request.contextPath}/EditAlbumServlet?id=<c:out value="${album.id}"/>">Edit</a>
                        &nbsp
                        <a href="${pageContext.request.contextPath}/DeleteAlbumServlet?id=<c:out value="${album.id}"/>">Delete</a>
                    </td>
                </tr>
            </c:forEach>
            </tbody>
